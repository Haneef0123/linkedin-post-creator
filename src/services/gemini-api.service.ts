...
export class GeminiApiService {
  ...
  async generatePost(params: GeminiGenerateRequest): Promise<ApiResponse<GeminiGenerateResponse>> {
    const endpoint = API_CONFIG.INTERNAL.ENDPOINTS.GENERATE_POST;
    
    const result = await this.apiClient.post<GeminiGenerateResponse>(endpoint, params);
  ...
  async generatePostDirect(params: GeminiGenerateRequest): Promise<ApiResponse<GeminiGenerateResponse>> {
    ...
    const result = await this.apiClient.post<GeminiResponseBody>(endpoint, requestBody);
